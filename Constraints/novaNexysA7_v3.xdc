## NOVA CPU with eight-digit display — Digilent Nexys A7-100T
...
## Active-low seven-segment cathodes and decimal point
...
## Active-low seven-segment anodes; AN[0] is rightmost
...
## Asynchronous controls are synchronized in RTL; LEDs and display outputs have
## no external synchronous timing requirement.
...
set_false_path -to [get_ports {CA CB CC CD CE CF CG DP AN[0] AN[1] AN[2] AN[3] AN[4] AN[5] AN[6] AN[7]}]

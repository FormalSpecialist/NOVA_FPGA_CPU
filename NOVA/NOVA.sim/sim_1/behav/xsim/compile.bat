...
REM
REM Generated by Vivado on Mon Sep 07 11:21:21 -0700 2026
...
echo "xvlog --incr --relax -prj novaNexysA7_tb_vlog.prj"
call xvlog  --incr --relax -prj novaNexysA7_tb_vlog.prj -log xvlog.log

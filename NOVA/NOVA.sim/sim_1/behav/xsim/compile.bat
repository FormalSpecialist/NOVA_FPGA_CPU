...
REM
REM Generated by Vivado on Mon Sep 07 13:20:21 -0700 2026
...
echo "xvlog --incr --relax -prj sevenSegmentDisplay_tb_vlog.prj"
call xvlog  --incr --relax -prj sevenSegmentDisplay_tb_vlog.prj -log xvlog.log

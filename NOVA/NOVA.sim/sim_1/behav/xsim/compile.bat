...
REM
REM Generated by Vivado on Mon Sep 07 16:37:28 -0700 2026
...
echo "xvlog --incr --relax -prj sumBoard_tb_vlog.prj"
call xvlog  --incr --relax -prj sumBoard_tb_vlog.prj -log xvlog.log
